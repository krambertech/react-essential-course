...
![Инициализация компонента (первый render)](/images/001.png)
...
![Изменение параметров](/images/002.png)
