...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ContactsList = __webpack_require__(159);
	...
	var ContactsList = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            'div',
	            { className: 'contacts' },
	            React.createElement('input', { type: 'text', className: 'search-field', onChange: this.handleSearch }),
	            React.createElement(
	                'ul',
	...
	var Contact = React.createClass({
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            ...
	            React.createElement('img', { className: 'contact-image', src: this.props.image, width: '60', height: '60', alt: this.props.name }),
	            React.createElement(
	                'div',
	                ...
	                React.createElement(
	                    'div',
	                    { className: 'contact-email ' + visibilityClass },
	                    this.props.email
	                ),
	                React.createElement(
	                    'div',
	                    { className: 'contact-address ' + visibilityClass },
	                    this.props.address
	                )
	            )
	        );
